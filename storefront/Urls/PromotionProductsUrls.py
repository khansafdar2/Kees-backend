...
from storefront.Views import StorefrontPromotionProducts as Promotions
from authentication.BusinessLogic.NeglectDefaultAuthentications import neglect_authentication


urlpatterns = [
    path('promotion_products', neglect_authentication(Promotions.PromotionProductView), name="PromotionProduct"),
