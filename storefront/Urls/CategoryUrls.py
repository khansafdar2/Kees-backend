...
from storefront.Views import StorefrontCategories as Categories
from authentication.BusinessLogic.NeglectDefaultAuthentications import neglect_authentication


urlpatterns = [
    path('categories_list', neglect_authentication(Categories.CategoryView), name="categories_list"),
    path('sub_category_list/<slug:slug>', neglect_authentication(Categories.SubCategoryView), name="Sub_category"),
